...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.yanzu";
    private static final String ARTIFACT_ID = "mazongjian";
    private static final String PACKAGE_NAME = "com.yanzu";
    private static final String TITLE = "麻总监管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.yanzu";
        String artifactIdNew = "mazongjian";
        String packageNameNew = "com.yanzu";
        String titleNew = "麻总监管理系统";
