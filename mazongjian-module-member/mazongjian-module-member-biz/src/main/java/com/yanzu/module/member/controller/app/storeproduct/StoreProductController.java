package com.yanzu.module.member.controller.app.storeproduct;
...
import com.yanzu.module.member.convert.storeproduct.StoreProductConvert;
import com.yanzu.module.member.dal.dataobject.storeproduct.StoreProductDO;
import com.yanzu.module.member.service.storeproduct.AppStoreProductService;
import com.yanzu.module.member.service.storeproduct.StoreProductService;
import com.yanzu.module.member.service.storeproduct.dto.StoreProductDto;
...
//    @PreAuthorize("@ss.hasPermission('shop:store-product:delete')")
    public CommonResult<Boolean> deleteStoreProduct(@PathVariable("id") Long id) {
...
//    @PreAuthorize("@ss.hasPermission('shop:store-product:query')")
    public CommonResult<PageResult<StoreProductRespVO>> getStoreProductPage(@RequestBody StoreProductPageReqVO pageVO) {
        PageResult<StoreProductDO> pageResult = storeProductService.getStoreProductPage(pageVO);
        PageResult<StoreProductRespVO> respVOPageResult = new PageResult<>();
        respVOPageResult.setList(BeanUtil.copyToList(pageResult.getList(),StoreProductRespVO.class));
...
//    @PreAuthorize("@ss.hasPermission('shop:store-product:export')")
    ...
    public CommonResult<Boolean> onSale(@RequestBody ChangeStatusReqVo changeStatusReqVo){
        storeProductService.onSale(changeStatusReqVo.getId(),changeStatusReqVo.getStatus());
        return success(true);
    }
    ...
    public CommonResult<List<AppCategoryRespVO>> goodsList(AppStoreProductQueryParam productQueryParam){
        return success(appStoreProductService.getGoodsList(productQueryParam));
    }
    ...
    public CommonResult<AppStoreProductRespVo> goodsDetail(@PathVariable Long id){
        return success(appStoreProductService.getStoreProductById(id));
    }
