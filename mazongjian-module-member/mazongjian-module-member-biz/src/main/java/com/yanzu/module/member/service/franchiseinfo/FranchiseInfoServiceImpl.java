...
public class FranchiseInfoServiceImpl implements FranchiseInfoService {
    ...
    @Override
    public Long createFranchiseInfo(FranchiseInfoCreateReqVO createReqVO) {
        // 插入
        FranchiseInfoDO franchiseInfo = FranchiseInfoConvert.INSTANCE.convert(createReqVO);
        franchiseInfoMapper.insert(franchiseInfo);
        // 返回
        return franchiseInfo.getId();
    }
