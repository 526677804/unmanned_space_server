...
public class FranchiseInfoRespVO extends FranchiseInfoBaseVO {
    ...
    @Schema(description = "ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "20443")
    private Long id;

    @Schema(description = "用户id", requiredMode = Schema.RequiredMode.REQUIRED, example = "20393")
    private Long userId;
