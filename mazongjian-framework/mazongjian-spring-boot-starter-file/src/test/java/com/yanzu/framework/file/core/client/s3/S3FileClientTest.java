...
public class S3FileClientTest {
    ...
    public void testMinIO() throws Exception {
        ...
        config.setBucket("mazongjianyuanma");
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.mazongjian.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.mazongjian.iocoder.cn
        // 默认上海的 endpoint
