package com.yanzu.framework.websocket.core;
...
public class MazongjianWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public MazongjianWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
