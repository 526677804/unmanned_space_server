...
* 演示地址【Vue3 + element-plus】：<http://dashboard-vue3.mazongjian.iocoder.cn>
* 演示地址【Vue3 + vben(ant-design-vue)】：<http://dashboard-vben.mazongjian.iocoder.cn>
* 演示地址【Vue2 + element-ui】：<http://dashboard.mazongjian.iocoder.cn>
...
* 管理后台的电脑端：Vue3 提供 [element-plus](https://gitee.com/mazongjiancode/mazongjian-ui-admin-vue3)、[vben(ant-design-vue)](https://gitee.com/mazongjiancode/mazongjian-ui-admin-vben) 两个版本，Vue2 提供 [element-ui](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/mazongjian-ui-admin) 版本
...
![架构演进](https://static.iocoder.cn/mazongjian-roadmap.png?imageView2/2/format/webp)
...
| [mazongjian-cloud](https://gitee.com/zhijiantianya/mazongjian-cloud)      | [![Gitee star](https://gitee.com/zhijiantianya/mazongjian-cloud/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/mazongjian-cloud) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/mazongjian-cloud.svg?style=social&label=Stars)](https://github.com/YunaiV/mazongjian-cloud)               | 基于 Spring Cloud 微服务架构       |
| [Spring-Boot-Labs](https://gitee.com/mazongjiancode/SpringBoot-Labs) | [![Gitee star](https://gitee.com/mazongjiancode/SpringBoot-Labs/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/mazongjian-cloud) [![GitHub stars](https://img.shields.io/github/stars/mazongjiancode/SpringBoot-Labs.svg?style=social&label=Stars)](https://github.com/mazongjiancode/SpringBoot-Labs) | 系统学习 Spring Boot & Cloud 专栏 |

### 前端项目

| 项目                                                                                                       | Star                                                                                                                                                                                                                                                                                                                                                           | 简介                                     |
|----------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|
| [mazongjian-ui-admin-vue3](https://gitee.com/mazongjiancode/mazongjian-ui-admin-vue3)                                   | [![Gitee star](https://gitee.com/mazongjiancode/mazongjian-ui-admin-vue3/badge/star.svg?theme=white)](https://gitee.com/mazongjiancode/mazongjian-ui-admin-vue3) [![GitHub stars](https://img.shields.io/github/stars/mazongjiancode/mazongjian-ui-admin-vue3.svg?style=social&label=Stars)](https://github.com/mazongjiancode/mazongjian-ui-admin-vue3)                                               | 基于 Vue3 + element-plus 实现的管理后台         |
| [mazongjian-ui-admin-vben](https://gitee.com/mazongjiancode/mazongjian-ui-admin-vben)                                   | [![Gitee star](https://gitee.com/mazongjiancode/mazongjian-ui-admin-vben/badge/star.svg?theme=white)](https://gitee.com/mazongjiancode/mazongjian-ui-admin-vben) [![GitHub stars](https://img.shields.io/github/stars/mazongjiancode/mazongjian-ui-admin-vben.svg?style=social&label=Stars)](https://github.com/mazongjiancode/mazongjian-ui-admin-vben)                                               | 基于 Vue3 + vben(ant-design-vue) 实现的管理后台 |
| [mazongjian-ui-admin](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/mazongjian-ui-admin)               | [![Gitee star](https://gitee.com/zhijiantianya/ruoyi-vue-pro/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/mazongjian-ui-admin) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/ruoyi-vue-pro.svg?style=social&label=Stars)](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/mazongjian-ui-admin)               | 基于 Vue2 + element-ui 实现的管理后台           |
| [mazongjian-ui-admin-uniapp](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/mazongjian-ui-admin-uniapp) | [![Gitee star](https://gitee.com/zhijiantianya/ruoyi-vue-pro/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/mazongjian-ui-admin-uniapp) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/ruoyi-vue-pro.svg?style=social&label=Stars)](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/mazongjian-ui-admin-uniapp) | 基于 uni-app + uni-ui 实现的管理后台的小程序        |
| [mazongjian-ui-go-view](https://gitee.com/mazongjiancode/mazongjian-ui-go-view)                                         | [![Gitee star](https://gitee.com/mazongjiancode/mazongjian-ui-go-view/badge/star.svg?theme=white)](https://gitee.com/mazongjiancode/mazongjian-ui-go-view) [![GitHub stars](https://img.shields.io/github/stars/mazongjiancode/mazongjian-ui-go-view.svg?style=social&label=Stars)](https://github.com/mazongjiancode/mazongjian-ui-go-view)                                                           | 基于 Vue3 + naive-ui 实现的大屏报表             |
| [mazongjian-ui-app](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/mazongjian-ui-app)                   | [![Gitee star](https://gitee.com/zhijiantianya/ruoyi-vue-pro/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/mazongjian-ui-app) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/ruoyi-vue-pro.svg?style=social&label=Stars)](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/mazongjian-ui-app)                   | 基于 uni-app + uview 实现的用户 App           |
...
| 项目                                                                       | 说明                 |
|--------------------------------------------------------------------------|--------------------|
| `mazongjian-dependencies`                                                     | Maven 依赖版本管理       |
| `mazongjian-framework`                                                        | Java 框架拓展          |
| `mazongjian-server`                                                           | 管理后台 + 用户 APP 的服务端 |
| `mazongjian-module-system`                                                    | 系统功能的 Module 模块    |
| `mazongjian-module-member`                                                    | 会员中心的 Module 模块    |
| `mazongjian-module-infra`                                                     | 基础设施的 Module 模块    |
| `mazongjian-module-bpm`                                                       | 工作流程的 Module 模块    |
| `mazongjian-module-pay`                                                       | 支付系统的 Module 模块    |
| `mazongjian-module-mall`                                                      | 商城系统的 Module 模块    |
| `mazongjian-module-mp`                                                        | 微信公众号的 Module 模块   |
| `mazongjian-module-report`                                                    | 大屏报表 Module 模块     |
...
| [Druid](https://github.com/alibaba/druid)                                                   | JDBC 连接池、监控组件    | 1.2.18      | [文档](http://www.iocoder.cn/Spring-Boot/datasource-pool/?mazongjian) |
| [MyBatis Plus](https://mp.baomidou.com/)                                                    | MyBatis 增强工具包    | 3.5.3.1     | [文档](http://www.iocoder.cn/Spring-Boot/MyBatis/?mazongjian)         |
| [Dynamic Datasource](https://dynamic-datasource.com/)                                       | 动态数据源            | 3.6.1       | [文档](http://www.iocoder.cn/Spring-Boot/datasource-pool/?mazongjian) |
| [Redis](https://redis.io/)                                                                  | key-value 数据库    | 5.0 / 6.0   |                                                                |
| [Redisson](https://github.com/redisson/redisson)                                            | Redis 客户端        | 3.18.0      | [文档](http://www.iocoder.cn/Spring-Boot/Redis/?mazongjian)           |
| [Spring MVC](https://github.com/spring-projects/spring-framework/tree/master/spring-webmvc) | MVC 框架           | 5.3.24      | [文档](http://www.iocoder.cn/SpringMVC/MVC/?mazongjian)               |
| [Spring Security](https://github.com/spring-projects/spring-security)                       | Spring 安全框架      | 5.7.6       | [文档](http://www.iocoder.cn/Spring-Boot/Spring-Security/?mazongjian) |
| [Hibernate Validator](https://github.com/hibernate/hibernate-validator)                     | 参数校验组件           | 6.2.5       | [文档](http://www.iocoder.cn/Spring-Boot/Validation/?mazongjian)      |
| [Flowable](https://github.com/flowable/flowable-engine)                                     | 工作流引擎            | 6.8.0       | [文档](https://doc.iocoder.cn/bpm/)                              |
| [Quartz](https://github.com/quartz-scheduler)                                               | 任务调度组件           | 2.3.2       | [文档](http://www.iocoder.cn/Spring-Boot/Job/?mazongjian)             |
| [Springdoc](https://springdoc.org/)                                                         | Swagger 文档       | 1.6.15      | [文档](http://www.iocoder.cn/Spring-Boot/Swagger/?mazongjian)         |
| [Resilience4j](https://github.com/resilience4j/resilience4j)                                | 服务保障组件           | 1.7.1       | [文档](http://www.iocoder.cn/Spring-Boot/Resilience4j/?mazongjian)    |
| [SkyWalking](https://skywalking.apache.org/)                                                | 分布式应用追踪系统        | 8.12.0      | [文档](http://www.iocoder.cn/Spring-Boot/SkyWalking/?mazongjian)      |
| [Spring Boot Admin](https://github.com/codecentric/spring-boot-admin)                       | Spring Boot 监控平台 | 2.7.10      | [文档](http://www.iocoder.cn/Spring-Boot/Admin/?mazongjian)           |
| [Jackson](https://github.com/FasterXML/jackson)                                             | JSON 工具库         | 2.13.3      |                                                                |
| [MapStruct](https://mapstruct.org/)                                                         | Java Bean 转换     | 1.5.5.Final | [文档](http://www.iocoder.cn/Spring-Boot/MapStruct/?mazongjian)       |
| [Lombok](https://projectlombok.org/)                                                        | 消除冗长的 Java 代码    | 1.18.28     | [文档](http://www.iocoder.cn/Spring-Boot/Lombok/?mazongjian)          |
