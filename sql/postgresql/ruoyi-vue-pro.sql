...
INSERT INTO "infra_config" ("id", "category", "type", "name", "config_key", "value", "visible", "remark", "creator",
                            "create_time", "updater", "update_time", "deleted")
VALUES (6, 'biz', 2, '登陆验证码的开关', 'mazongjian.captcha.enable', 'true', '1', NULL, '1', '2022-02-17 00:03:11', '1',
...
VALUES (4, '数据库', 1, '我是数据库', 'f',
        '{"@class":"com.yanzu.framework.file.core.client.db.DBFileClientConfig","domain":"http://127.0.0.1:48080"}',
        '1', '2022-03-15 23:56:24', '1', '2022-03-26 21:39:26', 0);
INSERT INTO "infra_file_config" ("id", "name", "storage", "remark", "master", "config", "creator", "create_time",
                                 "updater", "update_time", "deleted")
VALUES (5, '本地磁盘', 10, '测试下本地存储', 'f',
        '{"@class":"com.yanzu.framework.file.core.client.local.LocalFileClientConfig","basePath":"/Users/yunai/file_test","domain":"http://127.0.0.1:48080"}',
        '1', '2022-03-15 23:57:00', '1', '2022-03-26 21:39:26', 0);
INSERT INTO "infra_file_config" ("id", "name", "storage", "remark", "master", "config", "creator", "create_time",
                                 "updater", "update_time", "deleted")
VALUES (11, 'S3 - 七牛云', 20, NULL, 't',
        '{"@class":"com.yanzu.framework.file.core.client.s3.S3FileClientConfig","endpoint":"s3-cn-south-1.qiniucs.com","domain":"http://test.mazongjian.iocoder.cn","bucket":"ruoyi-vue-pro","accessKey":"b7yvuhBSAGjmtPhMFcn9iMOxUOY_I06cA_p0ZUx8","accessSecret":"kXM1l5ia1RvSX3QaOEcwI3RLz3Y2rmNszWonKZtP"}',
...
VALUES ('schedulerName', 'userSessionTimeoutJob', 'DEFAULT', NULL,
        'com.yanzu.framework.quartz.core.handler.JobHandlerInvoker', 'f', 't', 't', 'f',
...
VALUES (2, '维护通知：2018-07-01 若依系统凌晨维护',
        '<p><img src="http://test.mazongjian.iocoder.cn/b7cb3cf49b4b3258bf7309a09dd2f4e5.jpg">维护内容</p>', 2, 1, 'admin',
...
VALUES (1, 'default', 'admin123', '芋道源码', 'http://test.mazongjian.iocoder.cn/a5e2e244368878a366b516805a4aabf1.png',
...
INSERT INTO "system_oauth2_client" ("id", "client_id", "secret", "name", "logo", "description", "status",
                                    ...
                                    "additional_information", "creator", "create_time", "updater", "update_time",
                                    "deleted", "auto_approve_scopes")
VALUES (40, 'test', 'test2', 'biubiu', 'http://test.mazongjian.iocoder.cn/277a899d573723f1fcdfb57340f00379.png', NULL, 0,
...
VALUES (100, 'mazongjian', '$2a$10$11U48RhyJ5pSBYWSn12AD./ld671.ycSzJHbyrtpeoMeYiw31eo8a', '芋道', '不要吓我', 104, '[1]',
        'mazongjian@iocoder.cn', '15601691300', 1, '', 1, '', NULL, '', '2021-01-07 09:07:17', '104', '2021-12-16 09:26:10',
        0, 1);
INSERT INTO "system_users" ("id", "username", "password", "nickname", "remark", "dept_id", "post_ids", "email",
                            "mobile", "sex", "avatar", "status", "login_ip", "login_date", "creator", "create_time",
                            "updater", "update_time", "deleted", "tenant_id")
...
VALUES (1, 'admin', '$2a$10$0acJOIk2D25/oC87nyclE..0lzeu9DtQ/n3geP4fkun/zIVRhHJIO', '芋道源码', '管理员', 103, '[1]',
        'aoteman@126.com', '15612345678', 1, 'http://test.mazongjian.iocoder.cn/48934f2f-92d4-4250-b917-d10d2b262c6a', 0,
